...
public class RoomManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnUpdate.setBackground(new java.awt.Color(73, 17, 28));
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        // Empty check
        if (jtxtRoomID.getText().trim().isEmpty()) {
            jtxtRoomID.setBackground(Color.RED);
            valid = false;
        }

        if (jtxtPrice.getText().trim().isEmpty()) {
            jtxtPrice.setBackground(Color.RED);
            valid = false;
        }
        ...
        try {
            RoomNo = Integer.parseInt(jtxtRoomID.getText().trim());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Room No must be a number!", "Invalid Input", JOptionPane.ERROR_MESSAGE);
            jtxtRoomID.setBackground(Color.RED);
            jtxtRoomID.requestFocus();
            return;
        }
        try {
            Price = Integer.parseInt(jtxtPrice.getText().trim());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Price must be a number!", "Invalid Input", JOptionPane.ERROR_MESSAGE);
            jtxtPrice.setBackground(Color.RED);
